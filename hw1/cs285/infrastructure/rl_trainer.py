...
class RL_Trainer(object):
    ...
    def run_training_loop(self, n_iter, collect_policy, eval_policy,
                        ...
                        start_relabel_with_expert=5, expert_policy=None):
        """
    ...
    def collect_training_trajectories(self, itr, load_initial_expertdata,
        ...
        paths, envsteps_this_batch = sample_trajectories(self.env, collect_policy,
    ...
    def perform_logging(self, itr, paths, eval_policy, train_video_paths):
        ...
        eval_paths, eval_envsteps_this_batch = \
            sample_trajectories(self.env, eval_policy,
